...
data_root = 'data/st_kitti_unfiltered/'
...
db_sampler = dict(
    ...
    data_root='data/st_kitti_unfiltered/',
    info_path='data/st_kitti_unfiltered/st_kitti_unfiltered_dbinfos_train.pkl',
    points_loader=dict(
        backend_args=None,
        coord_type='LIDAR',
        load_dim=4,
            ...
            pipeline=[
                ...
                dict(
                    db_sampler=dict(
                        ...
                        data_root='data/st_kitti_unfiltered/',
                        info_path=
                        'data/st_kitti_unfiltered/st_kitti_unfiltered_dbinfos_train.pkl',
                        points_loader=dict(
                            backend_args=None,
                            coord_type='LIDAR',
                            load_dim=4,
...
work_dir = './work_dirs/pointpillars_hv_secfpn_8xb6-160e_kitti-3d-3class_unfiltered'
